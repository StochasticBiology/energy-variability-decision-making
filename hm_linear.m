...
NO = {'1','0.9','0.8','0.7','0.6','0.5','0.4','0.3','0.2','0.1','0'};%{'1','0.9','0.8','0.7'};%

%% steadystate quantity heatmaps
csvFileName = sprintf('%s\\number-stable-ss-linear.csv', dataFilesDirectory);
T = readtable(csvFileName);
	

%set activation values to produce heatmaps for
for a=[0,0.5,1,1.5,2,3]%1%
    ...
    figureFileName = sprintf('hm_linear_a=%.0f.svg',a*100);fullFileName=fullfile(figuresDirectory, figureFileName);print(fig_heatmap,fullFileName,'-dsvg');
end
