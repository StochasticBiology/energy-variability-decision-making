...
#
# thetaAStepsHigh = np.linspace(0.1, 1.5, 15)
# thetaB = 0.5
# for thetaAStep in range(len(thetaAStepsHigh)):
#     thetaA = round(thetaAStepsHigh[thetaAStep], 3)
#     print('thetaA = ' + str(thetaA))
#
#     energySteps = np.linspace(0, 1, 11)  # np.array([0.7])#
...
#             uniqueSSDataframe.loc[len(uniqueSSDataframe)] = [a, b, k, n, thetaA, thetaB, energy,
#                                                              uniqueSteadyStatesList[z][0], uniqueSteadyStatesList[z][1], uniqueSteadyStatesList[z][2]]
#         # # export to csv file without index col
#         csvFileName = "data-files/unique-steady-states-thetaA-high.csv"
...
#         # # export to csv file without index col
#         csvFileName3 = "data-files/number-stable-ss-thetaA-high.csv"
...
#                        'NumberSteadyStates', 'NumberStableSteadyStates'])
# print('\n')
# thetaBStepsHigh = np.linspace(0.1, 1.5, 15)
# thetaA = 0.5
# for thetaBStep in range(len(thetaBStepsHigh)):
#     thetaB = round(thetaBStepsHigh[thetaBStep], 3)
...
#                                                              uniqueSteadyStatesList[z][0], uniqueSteadyStatesList[z][1], uniqueSteadyStatesList[z][2]]
#         # # export to csv file without index col
#         csvFileName = "data-files/unique-steady-states-thetaB-high.csv"
#         export_Dataframe = uniqueSSDataframe.to_csv(csvFileName, index=False, header=True)
#
#         """
#         Number of STABLE steady states dataframe
...
#                                                                energy, len(uniqueSteadyStatesList), numStableMatches]
#         # # export to csv file without index col
#         csvFileName3 = "data-files/number-stable-ss-thetaB-high.csv"
#         export_Dataframe3 = numStableSSDataframe.to_csv(
#             csvFileName3, index=False, header=True)
...
thetaAStepsLow = np.linspace(0.01, 0.1, 10)
print('\n')
thetaB = 0.5
for thetaAStep in range(len(thetaAStepsLow)):
    thetaA = round(thetaAStepsLow[thetaAStep], 3)
    print('thetaA = ' + str(thetaA))
    ...
    for step in range(len(energySteps)):
        ...
        for z in range(len(uniqueSteadyStatesList)):
            ...
            uniqueSSDataframe.loc[len(uniqueSSDataframe)] = [a, b, k, n, thetaA, thetaB, energy,
                                                             uniqueSteadyStatesList[z][0], uniqueSteadyStatesList[z][1], uniqueSteadyStatesList[z][2]]
        # # export to csv file without index col
        csvFileName = "data-files/unique-steady-states-thetaA-low.csv"
        export_Dataframe = uniqueSSDataframe.to_csv(csvFileName, index=False, header=True)
        ...
        numStableSSDataframe.loc[len(numStableSSDataframe)] = [a, b, k, n, thetaA, thetaB,
                                                               energy, len(uniqueSteadyStatesList), numStableMatches]
        # # export to csv file without index col
        csvFileName3 = "data-files/number-stable-ss-thetaA-low.csv"
        export_Dataframe3 = numStableSSDataframe.to_csv(
            csvFileName3, index=False, header=True)
...
thetaBStepsLow = np.linspace(0.01, 0.1, 10)
print('\n')
thetaA = 0.5
for thetaBStep in range(len(thetaBStepsLow)):
    thetaB = round(thetaBStepsLow[thetaBStep], 3)
    print('thetaB = ' + str(thetaB))
    ...
    for step in range(len(energySteps)):
        ...
        for z in range(len(uniqueSteadyStatesList)):
            ...
            uniqueSSDataframe.loc[len(uniqueSSDataframe)] = [a, b, k, n, thetaA, thetaB, energy,
                                                             uniqueSteadyStatesList[z][0], uniqueSteadyStatesList[z][1], uniqueSteadyStatesList[z][2]]
        # # export to csv file without index col
        csvFileName = "data-files/unique-steady-states-thetaB-low.csv"
        export_Dataframe = uniqueSSDataframe.to_csv(csvFileName, index=False, header=True)
        ...
        numStableSSDataframe.loc[len(numStableSSDataframe)] = [a, b, k, n, thetaA, thetaB,
                                                               energy, len(uniqueSteadyStatesList), numStableMatches]
        # # export to csv file without index col
        csvFileName3 = "data-files/number-stable-ss-thetaB-low.csv"
        export_Dataframe3 = numStableSSDataframe.to_csv(
            csvFileName3, index=False, header=True)
