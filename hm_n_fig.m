...
NO_2 = {'0.7','0.6','0.5','0.4','0.3','0.2','0.1','0'};

%% steadystate quantity heatmaps

for n = [1,2,3,4]
	
	csvFileName = sprintf('%s\\number-stable-ss-n%.0f.csv',dataFilesDirectory,n);
    ...
    for a=[0,0.5,1,1.5,2,3]
        ...
        figureFileName = sprintf('hm_n%d_a=%.0f.svg',n,a*100);fullFileName=fullfile(figuresDirectory, figureFileName);print(fig_heatmap,fullFileName,'-dsvg');
    end
end
