...
for n = 4%[1,2,3,4]
    ...
    for a=[0,0.5,1,1.5,2,3]
        ...
        figureFileName = sprintf('hm_n%d_transition_dist_a=%.0f.svg',n,a*100);fullFileName=fullfile(figuresDirectory, figureFileName);print(fig_heatmap,fullFileName,'-dsvg');
    end
end
